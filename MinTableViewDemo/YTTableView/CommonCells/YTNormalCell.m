...
@property (nonatomic, strong) YTNormalCellViewModel *viewModel;

@end

@implementation YTNormalCell
...
- (void)configCellWithViewModel:(id)viewModel {
    ...
    YTNormalCellViewModel *vm = viewModel;
    _viewModel = vm;
